...
export type TemplateResponseTypes = Promie<ProductScriptResponses>
export type ProductScriptResponses = ProductScriptResponseSuccess | ProductScriptResponseError